...
BEGIN
    ...
    BEGIN
        ...
        INSERT INTO activity_log (
            ...
            'ERROR', COALESCE(v_message_text, 'Unknown SQL error'), p_created_user, 'ADMIN_REGISTERED_PARTNER_DELETE', 
        ...
        SELECT 
            ...
            COALESCE(v_message_text, 'Failed to delete partner') AS error_message;            
    END;

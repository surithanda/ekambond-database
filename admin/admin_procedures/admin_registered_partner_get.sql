...
BEGIN
    ...
    BEGIN
        ...
        INSERT INTO activity_log (
            log_type, message, activity_type, activity_details,
            start_time, end_time, execution_time
        ) VALUES (
            'ERROR', COALESCE(v_message_text, 'Unknown SQL error'), 'ADMIN_REGISTERED_PARTNER_GET', 
        ...
        SELECT 
            ...
            COALESCE(v_message_text, 'Failed to get partner') AS error_message;            
    END;
